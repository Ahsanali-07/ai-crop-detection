...
import { User, Settings, Upload, Calendar, LineChart } from 'lucide-react';
      ...
      <main className="flex-1 container px-4 py-8 md:py-12">
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="flex flex-col items-center md:flex-row md:items-start gap-6">
            <Avatar className="h-24 w-24 border-4 border-plant-500/20">
              {avatarUrl ? (
                <AvatarImage src={avatarUrl} alt={userName} />
              ) : (
                <AvatarFallback className="bg-plant-900 text-plant-100 text-xl">
            ...
            <div className="space-y-2 text-center md:text-left">
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                <span className="px-3 py-1 bg-plant-900/30 text-plant-300 text-sm rounded-full border border-plant-800/50">
                  Plant Enthusiast
                </span>
              </div>
            </div>
